...
/*   Updated: 2021/07/07 16:06:01 by vbachele         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	gestion_Affichage_Dash_Dot_Decimal(t_print *tab,
			long long i, int size, int j);
...
void	gestion_Dash_Pointeur(t_print *tab, unsigned long int nbr,
			int size, char *base, int j[size]);
...
void	gestion_Dot_Dash_Hexadecimal_x_X(t_print *tab,
			unsigned int i, char *base);
void	gestion_Dash_Dot_Hexadecimal_x_X(t_print *tab,
			unsigned int i, char *base);
void	gestion_Affichage_Dash_Dot_Hexadecimal_x_X(t_print *tab,
			unsigned int i, int size, char *base);
void	gestion_Zero_Hexadecimal_x_X(t_print *tab, unsigned int i, char *base);
void	gestion_Dot_Zero_Hexadecimal_x_X(t_print *tab,
			unsigned int i, char *base);
void	gestion_dash_Hexadecimal_x_X(t_print *tab,
			unsigned int i, char *base);
void	gestion_Sansflag_Hexadecimal_x_X(t_print *tab,
			unsigned int i, char *base);
void	gestion_Espace_Dot_Hexademal_x_X(t_print *tab,
			unsigned int i, int size);
